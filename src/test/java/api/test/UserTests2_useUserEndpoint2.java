...
import api.endpoints.UserEndPoints2_UsePropertiesFile;
import api.payload.User;
import io.restassured.module.jsv.JsonSchemaValidator;
import io.restassured.response.Response;

public class UserTests2_useUserEndpoint2 {
   Faker faker;
   User userPayload;
  ...
  @Test(priority=1)
   public void testPostUser() {
	   ...
	   Response response= UserEndPoints2_UsePropertiesFile.createUser(userPayload);
  ...
  @Test(priority=2)
   public void testGetUser() throws InterruptedException {
	   ...
	   Response response= UserEndPoints2_UsePropertiesFile.ReadUser(this.userPayload.getUsername());
       Assert.assertEquals(response.getStatusCode(),200 );
  ...
  @Test(priority=3)
   public void testUpdateUser() {
       ...
       Response responseAfterupdate= UserEndPoints2_UsePropertiesFile.ReadUser(this.userPayload.getUsername());
  ...
  public void testDeleteUser() {
	  ...
	  Response response= UserEndPoints2_UsePropertiesFile.DeleteUser(this.userPayload.getUsername());
      response.then().log().all();
      Assert.assertEquals(response.getStatusCode(),200 );
